.single_or_multiple <- function(z, omega_m, omega_k, omega_l, H0, multiple_func, single_func) {
    # returns either the single function or the multiple function based on z. 
    if (length(z) > 1) {
        multiple_func(z, omega_m, omega_k, omega_l, H0)
    } else {
        single_func(z, omega_m, omega_k, omega_l, H0)
    }
}
...
cosdistCoDist=function(z=1, H0=100, OmegaM=0.3, OmegaL=1-OmegaM-OmegaR, OmegaR=0, w0=-1, wprime=0, ref){
  ...
  OmegaK=1-OmegaM-OmegaL-OmegaR
  return(.single_or_multiple(z, OmegaM, OmegaK, OmegaL, H0, comoving_distances, comoving_distance))
}
...
cosdistCoDistTran=function(z=1, H0=100, OmegaM=0.3, OmegaL=1-OmegaM-OmegaR, OmegaR=0, w0=-1, wprime=0, ref){
  ...
  OmegaK=1-OmegaM-OmegaL-OmegaR
  return(.single_or_multiple(z, OmegaM, OmegaK, OmegaL, H0, comoving_transverse_distances, comoving_trans_distance))
}
...
cosdistLumDist=function(z=1, H0=100, OmegaM=0.3, OmegaL=1-OmegaM-OmegaR, OmegaR=0, w0=-1, wprime=0, ref){
  ...
  OmegaK=1-OmegaM-OmegaL-OmegaR
  co_dist_tran = .single_or_multiple(z, OmegaM, OmegaK, OmegaL, comoving_transverse_distances, comoving_trans_distance)
  return((1+z) * co_dist_tran)
}
...
cosdistDistMod=function(z=1, H0=100, OmegaM=0.3, OmegaL=1-OmegaM-OmegaR, OmegaR=0, w0=-1, wprime=0, ref){
  ...
  OmegaK=1-OmegaM-OmegaL-OmegaR
  return(.single_or_multiple(z, OmegaM, OmegaK, OmegaL, H0, dist_mods, dist_mods))
}
...
cosdistAngScale=function(z=1, H0=100, OmegaM=0.3, OmegaL=1-OmegaM-OmegaR, OmegaR=0, w0=-1, wprime=0, ref){
  ...
  OmegaK=1-OmegaM-OmegaL-OmegaR
  co_dist_tran = .single_or_multiple(z, OmegaM, OmegaK, OmegaL, comoving_transverse_distances, comoving_trans_distance)
  return((co_dist_tran / (1 + z)) * (pi/(180 * 60 * 60)) * 1000)
}
...
cosdistCoVol=function(z=1, H0=100, OmegaM=0.3, OmegaL=1-OmegaM-OmegaR, OmegaR=0, w0=-1, wprime=0, ref){
  ...
  OmegaK=1-OmegaM-OmegaL-OmegaR
  return(.single_or_multiple(z, OmegaM, OmegaL, OmegaK, H0, comoving_volumes, comoving_volume))
}
